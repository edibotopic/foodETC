...
<div title="click and drag nodes to rearrange the graph" id="observablehq-chart-7fb96fb1"></div>
...
import define from "https://api.observablehq.com/d/dc3dc8d5798f99dd.js?v=3";
new Runtime().module(define, name => {
  if (name === "chart") return new Inspector(document.querySelector("#observablehq-chart-7fb96fb1"));
});
</script>
...
$$seed \to seedling \to sapling \to tree \to log \to pulp \to paper \to book$$
