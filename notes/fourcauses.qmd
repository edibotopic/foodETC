...
In food science we are of course interested in *how to describe food*.
We want to develop *models* for understanding the different kinds of food we might encounter.
If possible, we would also like to categorise foods with similar characteristics.
An immediate challenge is that food is diverse and the abundance of scientific information about food is difficult to penetrate.
...
We can think of these as four (be)causes, as in *this object is what it is **because** of these four things*.
...
When thinking about any food product, food processing device or technology in general our description of it should account for these four causes (at a minimum) if we want to give a *complete explanation*.
...
> [...] food architects must choose the most appropriate building materials (ingredients) and assembly procedures (recipes) to construct the final product

It is worth noting that when an architect designs a bridge they are not merely thinking of how much cement and iron is needed, the associated costs and time required for manufacture (pragmatic aspects).
The most famous architects are also highly imaginative and design structures that people enjoy, that are considered beautiful and that become cultural icons.
...
There is also a strong tradition in architecture of developing theories of how architects should approach their work.
A famous example is the principle that **form follows function**, which basically means that how something that we design looks should reflect what it is supposed to do.
*This principle emphasis two of Aristotle's four causes and places the emphasis on function.*
...
It is not sufficient for a beverage that must be consumed through in hospital setting to have the right nutrients, as the liquid must also *function* such that it can flow reliably through a tube.
...
Consider some different foods or ingredients and how they might be defined according to the Four Causes?
Are there some cases where you can only adequately describe a fraction of the four – what does this suggest?
Should there be fifth, sixth or seventh causes to account for other important factors — what could they be?
