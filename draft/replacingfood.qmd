...
- It was initially promoted as a complete meal-replacer (quite the claim)
...
- It is largely equivalent — in principle — to products that pre-date Soylent (Abbott Ensure)
- The company repositioned itself recently to focus on "usage occasions" and expanded its range to include solid foods
...
- Its creator blogged extensively about its early development (some of these blogs are very thoughtful)
