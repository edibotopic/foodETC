...
<section data-auto-animate>
    <h3>Colours as Signs</h3>
    <br>
    <p style="color: red;">STOP</p>
    <p style="color: green;">GO</p>
    <p style="color: orange;">CAUTION</p>
    <br><br>
    <small class="fragment fade-up">Isn't color just light of a certain wavelength?</small>
</section>

<section data-auto-animate>
    <h3>Colours as Signs</h3>
    <br>
    <p style="color: green;">STOP</p>
    <p style="color: red;">GO</p>
    <p style="color: violet;">CAUTION</p>
    <br><br>
    <small>So we could just change the colors, right?</small>
</section>

<section data-auto-animate>
    <h3>Colours as Signs</h3>
    <br>
    <p style="color:rgb(167, 204, 35);">STOP</p>
    <p style="color:hotpink;">GO</p>
    <p style="color:darkturquoise;">CAUTION</p>
    <br><br>
    <small>The connection here is arbitrary.</small>
</section>


<section>
    <h3>Traffic Light Systems</h3>

    <iframe data-src="https://youtube.com/embed/tL8SeX-euko" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
    <br><br>
    <small class="fragment fade-up">Colors may signify health or danger</small>
</section>
...
```{=html}
    ...
    <img data-src="img/red_meat.jpg" width="60%" height="60%">
    <img data-src="img/red_meat_greyed.png" width="60%" height="60%">
    <img data-src="img/red_meat_enhanced.png" width="60%" height="60%">
    <img data-src="img/red_meat_browned.png" width="60%" height="60%">
    </div>
```

---

## Signifying red-wineness

<video src="vids/wine_col.mp4" autoplay loop>
    <a href="vids/wine_col.mp4">Video</a>
</video>


[Famous study on role of colour in wine-tasting](https://www.sciencedirect.com/science/article/abs/pii/S0093934X01924939)

---

### The Biosemiotics of Taste

|***Taste***                              |***Cellular activity***|***Evolutionary role***|***Example trigger***|
|:-----------------------------------------------|:-----------:|:-----------:|:------------------:|
|<stretch style="color:yellow">Sweet</stretch>     |Energy         |Non-toxicity          |Glucose		          |
|<stretch style="color:red">Bitter</stretch>        |Cell damage         |Poison          |Phenols	          |
|<stretch style="color:green">Salty</stretch>   |Cell signalling         |Electrolyte balance          |Sodium             |
|<stretch style="color:fuchsia">Sour</stretch> |pH regulation                  |Ripeness/safety	          |Protons |
|<stretch style="color:darkorange">Umami</stretch>       |Growth/repair         |Protein supply          |Glutamic acid		          |
||
...
```{=html}
<video id="fire_video" src="vids\art_sign.mp4" autoplay loop>
    <a href="vids\art_sign.mp4">Video</a>
</video>

<div class="fragment fade-in">
    <small>Smoke = natural sign | </small>
    <small>Floating fire = cultural sign | </small>
    <small>Fireworks = conventional sign</small>
</div>
```

<script>
    const slow_vid = document.getElementById("fire_video");

slow_vid.playbackRate = 0.6;
</script>

---

## Transferance of Meaning {background-color="black"}

<svg width="485pt" height="357.08pt" version="1.0" viewBox="0 0 285 157.08" xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <g id="dogan" fill="yellow" transform="matrix(.05 0 0 -.05 -4 167.64)" clip-path="url(#clipPath871)" fill="#f0f">
...
<small>Pavlov's dogs were conditioned to salivate in response to an arbitrary stimulus</small>	

---

## The logic of conditioning{background-color="black"}
<ul>
    <p style="color: yellow;">$$s \rightarrow \ R$$</p>	
    <p style="color: yellow;" class="fragment fade-up">$$NOT(x \rightarrow R)$$</p>
    <p style="color: yellow;" class="fragment fade-up">$$s \ AND \ x \rightarrow R$$</p>
    <p style="color: yellow;" class="fragment fade-up">$$x \rightarrow R$$</p>
</ul>
<small st class="fragment fade-left">The salience of the stimulus(<span style="color: yellow;">s</span>)
    is transferred to an arbitrary percept(<span style="color: yellow;">x</span>)</small>
...
<strong>Lobster was once the "insect of the sea"</strong>

---

<a class="fragment fade-left" href="https://www.theatlantic.com/health/archive/2014/09/the-world-war-ii-campaign-to-bring-organ-meats-to-the-dinner-table/380737/"
>Unfamiliar foods in WWII (Atlantic article)</a>

![](img\rations.jpg)

<a class="fragment fade-right" href="https://journals.sagepub.com/doi/10.1509/jppm.21.1.90.17614"
>Have important lessons been lost? (Wansink paper)</a>
...
<a href="https://www.warc.com/newsandopinion/news/how-premium-packaging-sells-valio-butter/40038">
    UCC graduate Kevin Deegan on <strong style="color: gold; background-color: black; font-family: serif;">Premium</strong> butter</a>

<small>image from www.valio.com/brands-and-products/</small>

---

<h2 style="color: black;">Saussure's Sign</h2>

```{=html}
<svg width="1491.4" height="1394.2" version="1.1" viewBox="-120 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
<g transform="translate(-27.527 -26.414)">
 <path id="circle" d="m224.83 28.667a195.42 195.42 0 0 0-195.05 183.43h390.1a195.42 195.42 0 0 0-195.05-183.43zm-195.05 207.41a195.42 195.42 0 0 0 195.05 183.43 195.42 195.42 0 0 0 195.05-183.43z" fill="#6fd1d1" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="4.5072"/>
 <text fill="#000000" font-family="'Times New Roman'" font-size="50.8px" style="line-height:1.25;shape-inside:url(#rect854);white-space:pre" xml:space="preserve"/>
 <g id="arrows" transform="matrix(.25559 0 0 .25559 20.491 19.663)" shape-rendering="auto">
  <g transform="matrix(1.1549 0 0 1.1549 -106.74 -140.98)">
   <path d="m345.76 492.88v601.74h10v-601.74z" color="#000000" color-rendering="auto" dominant-baseline="auto" image-rendering="auto" solid-color="#000000" stop-color="#000000" style="font-feature-settings:normal;font-variant-alternates:normal;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;font-variant-position:normal;font-variation-settings:normal;inline-size:0;isolation:auto;mix-blend-mode:normal;shape-margin:0;shape-padding:0;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-orientation:mixed;text-transform:none;white-space:normal"/>
   <g fill-rule="evenodd">
    <g transform="rotate(134.32 357.44 474.65)">
     <path d="m421.47 422.17v-56.569l-70.711 127.28 127.28-70.711z" color="#000000" color-rendering="auto" dominant-baseline="auto" image-rendering="auto" solid-color="#000000" stop-color="#000000" style="font-feature-settings:normal;font-variant-alternates:normal;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;font-variant-position:normal;font-variation-settings:normal;inline-size:0;isolation:auto;mix-blend-mode:normal;shape-margin:0;shape-padding:0;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-orientation:mixed;text-transform:none;white-space:normal"/>
     <path d="m426.81 345.02-89.771 161.59 161.59-89.771h-71.816zm-10.668 41.164v41.32h41.32l-92.971 51.65z" color="#000000" color-rendering="auto" dominant-baseline="auto" image-rendering="auto" solid-color="#000000" stop-color="#000000" style="font-feature-settings:normal;font-variant-alternates:normal;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;font-variant-position:normal;font-variation-settings:normal;inline-size:0;isolation:auto;mix-blend-mode:normal;shape-margin:0;shape-padding:0;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-orientation:mixed;text-transform:none;white-space:normal"/>
    </g>
    <g>
     <path d="m350.76 1075c11.04 0 20 8.96 20 20s-8.96 20-20 20-20-8.96-20-20 8.96-20 20-20z" color="#000000" color-rendering="auto" dominant-baseline="auto" image-rendering="auto" solid-color="#000000" stop-color="#000000" style="font-feature-settings:normal;font-variant-alternates:normal;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;font-variant-position:normal;font-variation-settings:normal;inline-size:0;isolation:auto;mix-blend-mode:normal;shape-margin:0;shape-padding:0;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-orientation:mixed;text-transform:none;white-space:normal"/>
     <path d="m350.76 1072.4c-12.483 0-22.666 10.185-22.666 22.668 0 12.483 10.183 22.666 22.666 22.666 12.483 0 22.666-10.183 22.666-22.666 0-12.483-10.183-22.668-22.666-22.668zm0 5.3339c9.5972 0 17.334 7.7369 17.334 17.334 0 9.5972-7.7368 17.332-17.334 17.332-9.5972 0-17.334-7.7349-17.334-17.332 0-9.5971 7.7368-17.334 17.334-17.334z" color="#000000" color-rendering="auto" dominant-baseline="auto" image-rendering="auto" solid-color="#000000" stop-color="#000000" style="font-feature-settings:normal;font-variant-alternates:normal;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;font-variant-position:normal;font-variation-settings:normal;inline-size:0;isolation:auto;mix-blend-mode:normal;shape-margin:0;shape-padding:0;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-orientation:mixed;text-transform:none;white-space:normal"/>
    </g>
   </g>
  </g>
  <g transform="matrix(-1.1549 .0016256 -.0016256 -1.1549 1639.8 1659.6)">
   <path d="m345.76 492.88v601.74h10v-601.74z" color="#000000" color-rendering="auto" dominant-baseline="auto" image-rendering="auto" solid-color="#000000" stop-color="#000000" style="font-feature-settings:normal;font-variant-alternates:normal;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;font-variant-position:normal;font-variation-settings:normal;inline-size:0;isolation:auto;mix-blend-mode:normal;shape-margin:0;shape-padding:0;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-orientation:mixed;text-transform:none;white-space:normal"/>
   <g fill-rule="evenodd">
    <g transform="rotate(134.32 357.44 474.65)">
     <path d="m421.47 422.17v-56.569l-70.711 127.28 127.28-70.711z" color="#000000" color-rendering="auto" dominant-baseline="auto" image-rendering="auto" solid-color="#000000" stop-color="#000000" style="font-feature-settings:normal;font-variant-alternates:normal;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;font-variant-position:normal;font-variation-settings:normal;inline-size:0;isolation:auto;mix-blend-mode:normal;shape-margin:0;shape-padding:0;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-orientation:mixed;text-transform:none;white-space:normal"/>
...
<text transform="translate(4.2333 11.642)" fill="#000000" font-family="sans-serif" 
 font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect943);white-space:pre" 
 xml:space="preserve"><tspan x="149.23438" y="125.08633"><tspan font-size="25.4px">SIGNIFIER</tspan></tspan></text>

 <text transform="translate(4.2333 206.38)" fill="#000000" font-family="sans-serif" 
 font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect957);white-space:pre" 
 xml:space="preserve"><tspan x="149.23438" y="125.08633"><tspan font-size="25.4px">SIGNIFIED</tspan></tspan></text> 
 </g>

 <g class="fragment fade-in-then-out">
        <text transform="translate(4.2333 11.642)" fill="#000000" font-family="sans-serif" 
         font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect943);white-space:pre" 
         xml:space="preserve"><tspan x="159.23438" y="125.08633"><tspan font-size="25.4px">"COFFEE"</tspan></tspan></text>

         <text transform="translate(4.2333 206.38)" fill="#000000" font-family="sans-serif" 
         font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect957);white-space:pre" 
         xml:space="preserve"><tspan x="129.23438" y="125.08633"><tspan font-size="25.4px">COFFEE (idea)</tspan></tspan></text> 
         </g>

         <g class="fragment fade-in-then-out">
            <text transform="translate(4.2333 11.642)" fill="#000000" font-family="sans-serif" 
             font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect943);white-space:pre" 
             xml:space="preserve"><tspan x="159.23438" y="125.08633"><tspan font-size="25.4px">RED LIGHT</tspan></tspan></text>

             <text transform="translate(4.2333 206.38)" fill="#000000" font-family="sans-serif" 
             font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect957);white-space:pre" 
             xml:space="preserve"><tspan x="159.23438" y="125.08633"><tspan font-size="25.4px">STOP (idea)</tspan></tspan></text> 
             </g>	 
 ...
 <g class="fragment fade-in-then-out">
    <text transform="translate(4.2333 11.642)" fill="#000000" font-family="sans-serif" 
     ...
     <text transform="translate(4.2333 206.38)" fill="#000000" font-family="sans-serif" 
     font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect957);white-space:pre" 
     xml:space="preserve"><tspan x="159.23438" y="125.08633"><tspan font-size="25.4px">ENERGY</tspan></tspan></text> 
     </g>
     ...
     <g class="fragment fade-in-then-out">
        <text transform="translate(4.2333 11.642)" fill="#000000" font-family="sans-serif" 
         ...
         <text transform="translate(4.2333 206.38)" fill="#000000" font-family="sans-serif" 
         font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect957);white-space:pre" 
         xml:space="preserve"><tspan x="139.23438" y="125.08633"><tspan font-size="25.4px">RELAXATION</tspan></tspan></text> 
         </g>

         <g class="fragment fade-in-then-out">
            <text transform="translate(4.2333 11.642)" fill="#000000" font-family="sans-serif" 
             font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect943);white-space:pre" 
             xml:space="preserve"><tspan x="169.23438" y="125.08633"><tspan font-size="25.4px">MEAT</tspan></tspan></text>

             <text transform="translate(4.2333 206.38)" fill="#000000" font-family="sans-serif" 
             font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect957);white-space:pre" 
             xml:space="preserve"><tspan x="149.23438" y="125.08633"><tspan font-size="25.4px">PROTEIN</tspan></tspan></text> 
             </g>

             <g class="fragment fade-in-then-out">
                <text transform="translate(4.2333 11.642)" fill="#000000" font-family="sans-serif" 
                 font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect943);white-space:pre" 
                 xml:space="preserve"><tspan x="179.23438" y="125.08633"><tspan font-size="25.4px">MEAT</tspan></tspan></text>

                 <text transform="translate(4.2333 206.38)" fill="#000000" font-family="sans-serif" 
                 font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect957);white-space:pre" 
                 xml:space="preserve"><tspan x="149.23438" y="125.08633"><tspan font-size="25.4px">MANLINESS</tspan></tspan></text> 
                 </g>

                 <g class="fragment fade-in-then-out">
                    <text transform="translate(4.2333 11.642)" fill="#000000" font-family="sans-serif" 
                     font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect943);white-space:pre" 
                     xml:space="preserve"><tspan x="179.23438" y="125.08633"><tspan font-size="25.4px"></tspan></tspan></text>

                     <text transform="translate(4.2333 206.38)" fill="#000000" font-family="sans-serif" 
                     font-size="25.4px" style="line-height:1.25;shape-inside:url(#rect957);white-space:pre" 
                     xml:space="preserve"><tspan x="149.23438" y="125.08633"><tspan font-size="25.4px"></tspan></tspan></text> 
                     </g>
